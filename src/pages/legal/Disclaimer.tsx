...
export default function Disclaimer() {
  return (
    <LegalPage title="Disclaimer" updated="January 1, 2026">
      <p>The information on the Get Funded Grants platform is provided for general informational purposes only. Get Funded Grants is not a lender, financial institution, tax advisor, or legal counsel. Nothing on the Platform constitutes financial, tax, or legal advice.</p>
      ...
      <p>Get Funded Grants does not disburse funds directly to applicants unless expressly agreed with a specific funder through a written services agreement. Where fund administration services are offered, applicable AML/KYC procedures will apply.</p>
